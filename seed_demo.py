...
def main():
    ...
    try:
        ...
        from app import ChatMessage, Conversation, LocationPing, Payment, PaymentEvent, Notification, Order, PasswordReset
        for model in [ChatMessage,Conversation,LocationPing,PaymentEvent,Payment,Notification,Order,Product,Vehicle,PasswordReset,User]: s.query(model).delete()
        s.commit()
        ph=None

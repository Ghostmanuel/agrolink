...
class Register(BaseModel):
    ...
    profile_photo_file_id:Optional[str]=Field(default=None,max_length=120)
    profile_photo_filename:Optional[str]=Field(default=None,max_length=180)
    profile_photo_content_type:Optional[str]=Field(default=None,max_length=120)
    profile_photo_data_base64:Optional[str]=Field(default=None,max_length=7500000)
...
class DeliveryQuote(BaseModel):
    ...
    vehicle_capacity_kg:Optional[float]=Field(default=None,gt=0)
...
class Chat(BaseModel):
    ...
    attachment_file_id:Optional[str]=Field(default=None,max_length=120)
...
class AdminSetting(BaseModel): value:str=Field(max_length=500)

class RatingCreate(BaseModel):
    order_id:int
    target_id:int
    target_role:Literal["buyer","seller","transporter"]
...
class DisputeResolve(BaseModel):
    status:Literal["RESOLVED","REJECTED","CLOSED"]

...
class Register(BaseModel):
    ...
    role:Literal["buyer","seller","transporter"]
...
class DeliveryQuote(BaseModel): distance_km:float=Field(ge=0); origin:Optional[str]=None; destination:Optional[str]=None
...
class Vehicle(BaseModel):
    plate:str=Field(min_length=4,max_length=20); model:str=""; vehicle_type:str="camião"; capacity_kg:float=Field(gt=0); photo:Optional[str]=None
